...
#d['this_target_frequency'] = d['this_target_frequency'].astype(float)
...
timecourse_plot(d, column='this_distractor_offset', label='Oct', ax=ax[1],
                window_len=window_len)
